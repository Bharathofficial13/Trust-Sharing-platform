...
if($at=='snt')
{
$qrt=mysql_query("update frlist set status='2' where id='$uid' && frid='$did'");
if($qrt)
{
$qrt=mysql_query("update frlist set status='2' where id='$did' && frid='$uid'");
$qrt;
...
if($at=='rjt')
{
$qrt=mysql_query("update frlist set status='0' where id='$uid' && frid='$did'");
if($qry)
{
$rt=mysql_query("update frlist set status='0' where id='$did' && frid='$uid'");
$rt;
header("location:accept.php");
}
}
				  ...
				  <div class="panel-body">
				      <form name="form1" method="post" action="">
                                  <div class="graph-visual tables-main">
                                    <h2 class="inner-tittle"> Friend  Request  </h2>
                                    <div class="graph">
                                      <div class="tables">
                                        <table class="table">
                                          <thead>
                                           ...
                                           <?php
									$i=1;
									$qry=mysql_query("select * from frlist where frid='$uid' && status='1'");
									...
									?>
									      ...
									      <tbody>
											...
											?>
                                              ...
                                              <td valign="middle"><a href="accept.php?act=snt&id=<?php echo $row['id'];?>">Accept</a>/<a href="accept.php?act=rjt&id=<?php echo $row['frid'];?>">Reject</a></td>
                                            </tr>
                                          </tbody>
										  <?php
										  $i++;
