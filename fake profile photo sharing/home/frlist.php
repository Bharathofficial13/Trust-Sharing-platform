				  ...
				  <div class="panel-body">
				     <form name="form1" method="post" action="">
                                  <div class="graph-visual tables-main">
                                    <h2 class="inner-tittle">Friend  List </h2>
                                    <div class="graph">
                                      <div class="tables">
									...
									?>
                                          <tbody>
											...
											?>
                                              <th scope="row"><img src="images/<?php echo $r['image'];?>" width="75" height="75" class="im1"></th>
                                              <td valign="middle"><?php echo $row['frname'];?></td>
                                              <td valign="middle">&nbsp;</td>
                                              <td valign="middle">&nbsp;</td>
                                            </tr>
                                          </tbody>
